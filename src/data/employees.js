export const employees = [
...

  {
    id: 'arhan-mansoori',
    name: 'Arhan Mansoori',
    jobTitle: 'Eternals Team Lead',
    department: 'Associate Data Engineer-1',
    location: 'Bhopal, MP',
    contact: '6281003819',
  ...
  },
  {
    ...
    keySkills: [
      ...
      'Analytical Abilities: Data Cleaning, Exploratory Data Analysis (EDA), ETL, Insight Generation',
  ...
  },
  {
    ...
    professionalIntro: "Results-driven Data Engineer with expertise in AWS and Azure, specializing in building scalable data pipelines using Databricks and PySpark. Proficient in Python, SQL, and Snowflake for data processing and transformation. Experienced in Terraform and Docker for efficient deployment, with strong skills in Git and data visualization using Power BI, Tableau, and Excel.",
    technicalSkills: []
  },
  {
    id: 'akhil-shrivas',
    ...
    keySkills: [
      ...
      'Data Science/ML: Pandas, NumPy, Scikit-learn, Streamlit',
  ...
  },
  {
    ...
    keySkills: [
      ...
      'Warehousing: Snowflake, Azure Synapse, PostgreSQL, SQL Server',
  ...
  },
  {
    ...
    keySkills: [
      ...
      'Data Engineering Tools: Apache Kafka, Apache Airflow, DBT, Microsoft Fabric',
      'Containerization: Docker',
      'Data bases/warehouses: MySQL, PostgreSQL, SSMS, Dbeaver, Snowflake',
      'Visualization: PowerBi, Tableau'
    ],
    professionalIntro: "I’m Bharti, a Data Engineer with experience in building and managing scalable data pipelines. I work with cloud platforms like AWS and Azure, and I’m experienced in handling ETL processes and real-time data streaming. I focus on ensuring data quality, optimizing workflows, and transforming raw data into meaningful insights that support business decisions.",
    technicalSkills: []
  },
  {
    id: 'muskan-mahalwar',
    ...
    keySkills: [
      ...
      'Big Data & Data Engineering Tools- Apache Kafka, Apache Airflow, Databricks',
      'Cloud Platforms-Amazon Web Services (AWS),Microsoft Azure,Google Cloud Platform (GCP)',
      'Data Warehousing & Analytics Platforms- Snowflake, Azure Synapse Analytics, Microsoft Fabric',
      'Data Visualization & Reporting- Microsoft Power BI, Tableau, Microsoft Excel, Apache Superset'
    ],
    professionalIntro: "I’m Muskan, an Associate Data Engineer Intern. I work on data-driven solutions and building data pipelines that help transform raw data into useful insights. I enjoy learning new technologies and continuously improving my skills in the data engineering field. In my free time, I like exploring new tools and staying updated with the latest trends in data and cloud technologies.",
    technicalSkills: []
  },
  {
    id: 'aryan-sharma',
    ...
    keySkills: [
      ...
      'Databases & Data Warehousing- MySQL, Oracle (Oracle SQL Developer), AWS RDS',
      'Data Warehousing / Storage- Snowflake, Databricks, Azure Data Lake Storage Gen2 (ADLS Gen2), AWS S3',
      'Data Engineering & ETL Tools-, AWS Glue, SQL Server Integration Services (SSIS), Databricks, Apache Airflow, Apache Kafka',
  ...
  },
  {
    ...
    professionalIntro: "I enjoy exploring new technologies and staying updated with trends in data engineering and analytics. In my free time, I like working on small projects, designing dashboards, and learning new tools. I also enjoy listening to music and exploring creative ideas related to digital content.",
    technicalSkills: []
  },
  {
    id: 'anurag-sathe',
